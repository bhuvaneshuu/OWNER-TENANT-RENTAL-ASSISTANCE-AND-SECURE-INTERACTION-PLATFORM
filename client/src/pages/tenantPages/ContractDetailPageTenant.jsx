        ...
        <div ref={contractRef} className="bg-white rounded-2xl shadow-2xl px-8 py-10 border border-slate-200 mt-10">
          ...
          <div className="flex flex-col md:flex-row justify-between gap-8 mb-8">
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-600 mb-1"><EmailRoundedIcon fontSize="small" /> {contractDetail?.owner?.email}</div>
              <div className="flex items-center gap-2 text-sm text-gray-600"><LocalPhoneRoundedIcon fontSize="small" /> {contractDetail?.owner?.phoneNumber}</div>
            </div>
            <div className="flex-1">
